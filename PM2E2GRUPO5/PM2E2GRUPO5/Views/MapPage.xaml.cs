                ...
                if (status == PermissionStatus.Granted)
                {
                    ...
                    if (localizacion != null)
                    {
                        var pin = new Pin()
                        {
                            ...
                            Position = new Position(Sitio.Latitud, Sitio.Longitud),
                            Label = "Descripcion",
                        ...
                        mapa.MoveToRegion(MapSpan.FromCenterAndRadius(new Position(Sitio.Latitud, Sitio.Longitud), Distance.FromMeters(100)));
                    }
                }
                else
                {
