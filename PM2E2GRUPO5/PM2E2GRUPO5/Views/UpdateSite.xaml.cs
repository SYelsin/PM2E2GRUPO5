    ...
    public partial class UpdateSite : ContentPage
    {
        ...
        private async void btnUpdate_Clicked(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                var result = await SitioController.UpdateSitio(sitio); // Actualizar el sitio en lugar de crearlo
                ...
                if (result)
                {
                    await DisplayAlert("Aviso", "Sitio actualizado correctamente", "OK"); // Cambiar el mensaje de éxito
                    await Navigation.PushModalAsync(new ListSite());
                }
                else
                {
                    await DisplayAlert("Aviso", "No se pudo actualizar el sitio", "OK"); // Cambiar el mensaje de error
                }
            }
            catch (Exception ex)
            {
